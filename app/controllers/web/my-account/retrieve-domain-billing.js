...
const handleStripeRedirect = require('./handle-stripe-redirect');
...
async function retrieveDomainBilling(ctx) {
  ...
  try {
    ...
    if (isSANB(ctx.query.session_id))
      await handleStripeRedirect(ctx, isMakePayment);
